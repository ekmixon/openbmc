...
def model_parser(ap):
    ...
    ap.add_argument(
        "--model",
        default=at93cx6.AT93C46,
        choices=[at93cx6.AT93C46, at93cx6.AT93C56, at93cx6.AT93C66, at93cx6.AT93C86],
...
def access_parser(ap):
    ...
    spi_group.add_argument(
        ...
        help="The GPIO number/shadow name for SPI CS pin (default: %(default)s)",
    )
    spi_group.add_argument(
        "--clk",
        type=str,
        default=SPI_CLK_DEFAULT,
        help="The GPIO number/shadow name for SPI CLK pin (default: %(default)s)",
    )
    spi_group.add_argument(
        "--mosi",
        type=str,
        default=SPI_MOSI_DEFAULT,
        help="The GPIO number/shadow name for SPI MOSI pin (default: %(default)s)",
    )
    spi_group.add_argument(
        "--miso",
        type=str,
        default=SPI_MISO_DEFAULT,
        help="The GPIO number/shadow name for SPI MISO pin (default: %(default)s)",
    )
...
def bus_width_parser(ap):
    ...
    bus_group.add_argument(
        ...
        help="The configured bus width " "(default: %(default)s)",
    )
...
def chip_subparser(subparsers):
    ...
    read_parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Byte swap values for 16-bit reads/writes " "(default: %(default)s)",
    )
